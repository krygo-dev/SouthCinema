...
void main() {
  ...
  group('createNewReservation', () {
    ...
    test('should return true when setting data was successful', () async {
      ...
      verify(
        mockScreeningsService.updateScreeningSeatsTaken(
            tReservation.screeningId, tReservation.seats),
      );
    });
  ...
  group('getUserReservations', () {
    ...
    test('''should get all documents from reservation collection where 
      userId is equal provided id and return them as list of Reservation''',
        () async {
      // arrange
