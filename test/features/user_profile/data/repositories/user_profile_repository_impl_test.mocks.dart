...
// in south_cinema/test/features/user_profile/data/repositories/user_profile_repository_impl_test.dart.
...
class MockUserService extends _i1.Mock implements _i3.UserService {
  ...
  @override
  _i4.Future<_i2.User> getUserById(String? uid) => (super.noSuchMethod(
        Invocation.method(
          #getUserById,
          [uid],
        ),
  ...
  @override
  _i4.Future<bool> setOrUpdateUserData(_i2.User? user) => (super.noSuchMethod(
        Invocation.method(
          #setOrUpdateUserData,
          [user],
        ),
